...
class DataTransformation:
    ...
    def initiate_data_transformation(self,train_path,test_path):
        ...
        try :
            ...
            logging.info('training and testing arrays prepared')


            save_object(file_path=self.data_transform_config.preprocessing_obj_file_path,
                        obj=preprocessing_obj
                        )

            logging.info('saved preprocessing object')

            return(train_arr, test_arr ,self.data_transform_config.preprocessing_obj_file_path)
        except Exception as e:
            raise CustomException(e,sys)
